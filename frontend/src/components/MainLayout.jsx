...
import { footerHighlights } from "../content/siteData";
import { resolveLocalizedValue } from "../utils/localization";

const navItems = [
  { key: "nav_home", to: "/" },
  { key: "nav_feed", to: "/growth-tracker" },
  { key: "nav_maps", to: "/project-maps" },
  { key: "nav_growth", to: "/future-growth" },
      ...
      <Drawer anchor="right" open={open} onClose={() => setOpen(false)}>
        <Box sx={{ width: 300, p: 3 }}>
          ...
          <Stack spacing={1.5} sx={{ mt: 3 }}>
            ...
            <Button component={NavLink} to="/project-maps" startIcon={<MapOutlinedIcon />}>
              {t("cta_map_request")}
            </Button>
          </Stack>
        </Box>
