...
class TravelLifestylePage extends StatefulWidget {
  const TravelLifestylePage({super.key});

  @override
  State<TravelLifestylePage> createState() => _TravelLifestylePageState();
}

class _TravelLifestylePageState extends State<TravelLifestylePage> {
  final ApiService _apiService = ApiService();

  @override
  void initState() {
    super.initState();
    _apiService.trackActivity('Travel & Lifestyle');
  }
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: const Text('Travel & Lifestyle', style: TextStyle(fontSize: 16)),
              background: Stack(
                fit: StackFit.expand,
                children: [
                  Image.asset(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Information on the upcoming international airport, expressway, and lifestyle amenities.',
