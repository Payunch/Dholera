...
class PlotsForSalePage extends StatefulWidget {
  const PlotsForSalePage({super.key});

  @override
  State<PlotsForSalePage> createState() => _PlotsForSalePageState();
}

class _PlotsForSalePageState extends State<PlotsForSalePage> {
  final ApiService _apiService = ApiService();

  @override
  void initState() {
    super.initState();
    _apiService.trackActivity('Plots for Sale');
  }
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: const Text('Plots for Sale', style: TextStyle(fontSize: 16)),
              background: Stack(
                fit: StackFit.expand,
                children: [
                  Image.network(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'VERIFIED COMMERCIAL & RESIDENTIAL PLOTS',
                    style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, height: 1.1),
                  ),
                  const SizedBox(height: 24),
                  Text(
                    'Browse our curated list of RERA-approved plots in Town Planning areas of Dholera Smart City.',
