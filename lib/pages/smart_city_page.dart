...
class SmartCityPage extends StatefulWidget {
  const SmartCityPage({super.key});

  @override
  State<SmartCityPage> createState() => _SmartCityPageState();
}

class _SmartCityPageState extends State<SmartCityPage> {
  final ApiService _apiService = ApiService();

  @override
  void initState() {
    super.initState();
    _apiService.trackActivity('Smart City Features');
  }
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: const Text('Smart City Features', style: TextStyle(fontSize: 16)),
              background: Stack(
                fit: StackFit.expand,
                children: [
                  Image.network(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Discover the IoT-enabled infrastructure, smart grids, and sustainable design powering Dholera.',
