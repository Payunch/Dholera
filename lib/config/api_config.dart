...
class ApiConfig {
  ...
  static String get apiBaseUrl =>
      useLocalBackend ? 'http://$localIp:3001/api' : productionUrl;
  // ---------------------
  ...
  static String get exportSessionsEndpoint =>
      '$apiBaseUrl/analytics/export/sessions';
  static String get exportUpdatesEndpoint =>
      '$apiBaseUrl/analytics/export/updates';
  ...
  // New User Auth flow
  static String get registerRequestEndpoint =>
      '$apiBaseUrl/leads/register-request';
  static String get verifyRegistrationOtpEndpoint =>
      '$apiBaseUrl/leads/verify-registration-otp';
  static String get setupPasscodeEndpoint => '$apiBaseUrl/leads/setup-passcode';
  static String get loginWithPasscodeEndpoint =>
      '$apiBaseUrl/leads/login-with-passcode';
  static String get userSignupEndpoint => '$apiBaseUrl/user-auth/signup';
  static String get userLoginEndpoint => '$apiBaseUrl/user-auth/login';
  static String get userMeEndpoint => '$apiBaseUrl/user-auth/me';
  static String get forgotPasswordEndpoint =>
      '$apiBaseUrl/user-auth/forgot-password';
  static String get resetPasswordEndpoint =>
      '$apiBaseUrl/user-auth/reset-password';
  ...
  static String get detailedAnalyticsEndpoint =>
      '$apiBaseUrl/analytics/detailed';
  ...
  static String get appInfoEndpoint => '$apiBaseUrl/settings/app-info';

  // Preferences endpoints
  static String get preferencesEndpoint => '$apiBaseUrl/preferences';
  static String get translationsEndpoint =>
      '$apiBaseUrl/preferences/translations';
}
